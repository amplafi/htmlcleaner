...
//        assertTrue(xmlString, xmlString.indexOf("<div>&amp;&quot;&#39;&lt;&gt;</div>") >= 0 );
        ...
        assertTrue( getXmlString(true).indexOf("<script>var x=y&amp;&amp;z;</script>") >= 0 );
        assertTrue( getXmlString(true).indexOf("<style>.test{font-size:10;}</style>") >= 0 );
        ...
        assertTrue( getXmlString(true).indexOf(specialHtmlEntities) < 0 );

        String unicodeCharString = "<div>"+ new String(new char[] {352, 8224,8249})+"</div>";
        properties.setRecognizeUnicodeChars(true);
        assertTrue( getXmlString(true).indexOf(unicodeCharString) >= 0 );
        properties.setRecognizeUnicodeChars(false);
        assertTrue( getXmlString(true).indexOf(unicodeCharString) < 0 );
        assertTrue( getXmlString(true).indexOf("<div>&amp;#352;&amp;#8224;&amp;#8249;</div>") >= 0 );

        properties.setOmitUnknownTags(true);
        assertTrue( getXmlString(true).indexOf("<mytag>content of unknown tag</mytag>") < 0 );
        assertTrue( getXmlString(true).indexOf("content of unknown tag") >= 0 );
        ...
        assertTrue( getXmlString(true).indexOf("<u>content of deprecated tag</u>") < 0 );
        assertTrue( getXmlString(true).indexOf("content of deprecated tag") >= 0 );
        ...
        assertTrue( getXmlString(true).indexOf("<!--my comment-->") >= 0 );
        properties.setOmitComments(true);
        assertTrue( getXmlString(true).indexOf("<!--my comment-->") < 0 );

        properties.setOmitXmlDeclaration(false);
        assertTrue( getXmlString(true).indexOf("<?xml version=\"1.0\"") >= 0 );
        properties.setOmitXmlDeclaration(true);
        assertTrue( getXmlString(true).indexOf("<?xml version=\"1.0\"") < 0 );

        properties.setOmitDoctypeDeclaration(false);
        assertTrue( getXmlString(true).indexOf("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\">") >= 0 );
        properties.setOmitDoctypeDeclaration(true);
        assertTrue( getXmlString(true).indexOf("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\">") < 0 );

        properties.setOmitHtmlEnvelope(true);
        assertTrue( getXmlString(true).indexOf("<html><head>") < 0 );
        assertTrue( getXmlString(true).indexOf("</body></html>") < 0 );
        ...
        assertTrue( getXmlString(true).indexOf("<div att=\"a b c\">") < 0 );
        assertTrue( getXmlString(true).indexOf("<div att=\"a\" b=\"b\" c=\"c\">") >= 0 );
        properties.setAllowMultiWordAttributes(true);
        assertTrue( getXmlString(true).indexOf("<div att=\"a b c\">") >= 0 );

        properties.setAllowHtmlInsideAttributes(true);
        assertTrue( getXmlString(true).indexOf("<a title=\"&lt;b&gt;Title&lt;b&gt; is here\">LINK 1</a>") >= 0 );
        properties.setAllowHtmlInsideAttributes(false);
        assertTrue( getXmlString(true).indexOf("<a title=\"&lt;b&gt;Title&lt;b&gt; is here\">LINK 1</a>") < 0 );
        assertTrue( getXmlString(true).indexOf("<a title=\"\"><b>Title<b> is here&quot;&gt;LINK 1</b></b></a>") >= 0 );

        properties.setIgnoreQuestAndExclam(true);
        assertTrue( getXmlString(true).indexOf("&lt;!INSTRUCTION1 id=&quot;aaa&quot;&gt;") < 0 );
        assertTrue( getXmlString(true).indexOf("&lt;?INSTRUCTION2 id=&quot;bbb&quot;&gt;") < 0 );
        properties.setIgnoreQuestAndExclam(false);
        assertTrue( getXmlString(true).indexOf("&lt;!INSTRUCTION1 id=&quot;aaa&quot;&gt;") >= 0 );
        assertTrue( getXmlString(true).indexOf("&lt;?INSTRUCTION2 id=&quot;bbb&quot;&gt;") >= 0 );

        properties.setNamespacesAware(true);
        assertTrue( getXmlString(true).indexOf("<html xmlns:my=\"my\">") >= 0 );
        assertTrue( getXmlString(true).indexOf("<my:tag id=\"xxx\">aaa</my:tag>") >= 0 );
        properties.setNamespacesAware(false);
        assertTrue( getXmlString(true).indexOf("<html") >= 0 );
        assertTrue( getXmlString(true).indexOf("<tag id=\"xxx\">aaa</tag>") >= 0 );

        properties.setOmitComments(false);
        assertTrue( getXmlString(true).indexOf("<!-- comment with == - hyphen -->") >= 0 );
        ...
        assertTrue( getXmlString(true).indexOf("<input checked=\"true\" />") >= 0 );
        properties.setBooleanAttributeValues("selft");
        assertTrue( getXmlString(true).indexOf("<input checked=\"checked\" />") >= 0 );
    }

    private String getXmlString(boolean xmlGeneration) throws IOException {
